...
## Environment
Environment can be created using the command **conda env create -f my_conda_env.yml**. [Google]([https://google.com](https://github.com/compbiolabucf/TSEst/blob/main/my_conda_env.yml)) 
