...
class TransformerEncoder(nn.Module):
    def __init__(self, n_groups, n_group_inner_layers, d_time, d_feature, d_model, d_inner, n_head, d_k, d_v, dropout,
        ...
        self.embedding_112 = nn.Linear(14, d_model)
    ...
    def impute(self, inputs,stage):
        ...
        STEP1_loss += masked_mae_cal(X_tilde_11, X, masks)
        ...
        for sample_idx in range(n_sample):
            ...
            corr1 = torch.where(corr1>0,corr1,-1/corr1)
            corr2 = torch.where(corr2>0,corr2,-1/corr2)
    ...
    def forward(self, inputs, stage):
        ...
        imputed_data, learned_presentation, STEP1_loss = self.impute(inputs,stage)
